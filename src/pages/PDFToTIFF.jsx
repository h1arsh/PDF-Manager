...
const PDFToTIFF = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/api/pdf/convert-to-tiff', {
        method: 'POST',
        body: formData,
      });
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to convert PDF to TIFF');
      }
      ...
      a.href = url;
      a.download = `${pdfFiles[0].name.replace('.pdf', '')}_converted.tiff`;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      <Helmet>
        ...
        <meta name="description" content="Convert PDF documents into TIFF files completely for free" />
      </Helmet>
      ...
      <div className="text-center">
        ...
        <h5 className="mt-3 text-xl text-gray-500 max-w-2xl mx-auto">
          Convert PDF documents into TIFF files completely for free
        </h5>
      </div>
