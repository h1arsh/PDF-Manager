...
const JPGToPDF = () => {
  ...
  const { getRootProps, getInputProps } = useDropzone({
    accept: {
      'image/jpeg': ['.jpg', '.jpeg'],
      'image/png': ['.png'] // Optional: include PNG if you want to support it too
    },
    multiple: true,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Submitting images for PDF conversion:', {
        files: imageFiles,
        layout: layoutOption,
        margin: marginSize
      });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="text-center">
          ...
          <h5 className="mt-3 text-xl text-gray-500 max-w-2xl mx-auto">
            Convert JPG images into PDF files with our easy-to-use FREE online converter tool.
          </h5>
        </div>
        ...
        <div className="mt-12 max-w-3xl mx-auto">
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <h3 className="text-lg font-medium text-gray-900">Drag and drop your JPG images here</h3>
